...
start_date_str = '2018-03-30-00-00'; 
...
the_time_moment =   datetime.datetime(2018, 3, 30, 8, 0)   
...
the_first_aux_time_moment = datetime.datetime(18, 3, 30, 6, 25)
the_second_aux_time_moment = datetime.datetime(18, 3, 30, 6, 50)
...
the_first_field_time_moment = datetime.datetime(18, 3, 30, 8, 0) + (the_second_aux_time_moment - the_first_aux_time_moment)
the_second_field_time_moment = datetime.datetime(18, 3, 30, 8, 0)    + (the_second_aux_time_moment - the_first_aux_time_moment)
the_third_field_time_moment = datetime.datetime(18, 3, 30, 8, 0) + (the_second_aux_time_moment - the_first_aux_time_moment)
the_fourth_field_time_moment = datetime.datetime(18, 3, 30, 8, 0)  + (the_second_aux_time_moment - the_first_aux_time_moment)
the_fifth_field_time_moment = datetime.datetime(18, 3, 30, 8, 0) + (the_second_aux_time_moment - the_first_aux_time_moment)
the_sixth_field_time_moment = datetime.datetime(18, 3, 30, 8, 0) + (the_second_aux_time_moment - the_first_aux_time_moment)
...
#for j_str in range (0, 1):
    ...
    print(j_datetime)
    field_temp_array = model2_for_HDF.get_aux_speed_array(csv_data.iloc[:, 1], aux_pressure_height_number)
...
file = model2_for_HDF.get_wrf_file(model_datetime)
...
z_vector = model2_for_HDF.get_height(model_datetime, 45)[:-1]
...
wrf_temperature_vector = model2_for_HDF.get_t2(model_datetime, model_period, model_length, event_datetime, number_of_time_points);
...
wrf_pressure_vector = model2_for_HDF.get_s_pressure(model_datetime, model_period, model_length, event_datetime, number_of_time_points);
coef = round( csv_length/  number_of_time_points)
...
time_start_index =  csv_length*0;
time_finish_index =  csv_length - 1;
